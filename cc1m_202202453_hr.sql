...
COMMENT ON COLUMN hr.localizacoes.unidade_federal IS 'Abreviação para Unidade Federal. Estado onde o escritório ou facilidade da empresa está localizado.';
...
CREATE TABLE hr.historico_cargos (
                ...
                id_departamento INTEGER NOT NULL,
                id_cargo INTEGER NOT NULL,
                CONSTRAINT id_empregado PRIMARY KEY (data_inicial, id_empregado)
);
