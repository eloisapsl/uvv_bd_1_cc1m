/* Acessando o usuário root no MySQL */

mysql -u root -p 
    computacao@raiz

/* Criando o usuário eloisa e dando as devidas permissões no banco de dados*/
CREATE USER 'eloisa'@localhost identified by 'eloisapajehu';
         
GRANT ALL ON uvv.* TO 'eloisa'@localhost;

/* Acessando o usuário eloisa para a criação do banco de dados uvv */
...
/* Selecionando o banco de dados uvv para manipulação */

USE uvv;

/* Criando tabelas para inserção de dados */
...
/* Criação da chave única da tabela */
...
/* Inserindo as Foreign Keys das tabelas */
